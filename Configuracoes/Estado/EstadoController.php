...
class EstadoController extends \Zion\Core\Controller
{
    ...
    {
        $this->class = new \Sappiens\Configuracoes\Estado\EstadoClass();
        $this->form = new \Sappiens\Configuracoes\Estado\EstadoForm();
    } 
