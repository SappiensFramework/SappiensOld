...
class CidadeController extends \Zion\Core\Controller
{
    ...
    {
        $this->class = new \Sappiens\Configuracoes\Cidade\CidadeClass();
        $this->form = new \Sappiens\Configuracoes\Cidade\CidadeForm();
    } 
