var urlStatic = "//localhost/Sappiens/Static/";
// Polyfills
//
(function() {
  // Array indexOf
...
var demo_themes = [
  { name: 'default', title: 'Default', img: urlStatic+'PixelAdmin/1.3.0/assets/demo/themes/default.png' },
  { name: 'asphalt', title: 'Asphalt', img: urlStatic+'PixelAdmin/1.3.0/assets/demo/themes/asphalt.png' },
  { name: 'purple-hills', title: 'Purple Hills', img: urlStatic+'PixelAdmin/1.3.0/assets/demo/themes/purple-hills.png' },
  { name: 'adminflare',  title: 'Adminflare', img: urlStatic+'PixelAdmin/1.3.0/assets/demo/themes/adminflare.png' },
  { name: 'dust',  title: 'Dust', img: urlStatic+'PixelAdmin/1.3.0/assets/demo/themes/dust.png' },
  { name: 'frost',  title: 'Frost', img: urlStatic+'PixelAdmin/1.3.0/assets/demo/themes/frost.png' },
  { name: 'fresh',  title: 'Fresh', img: urlStatic+'PixelAdmin/1.3.0/assets/demo/themes/fresh.png' },
  { name: 'silver',  title: 'Silver', img: urlStatic+'PixelAdmin/1.3.0/assets/demo/themes/silver.png' },
  { name: 'clean',  title: 'Clean', img: urlStatic+'PixelAdmin/1.3.0/assets/demo/themes/clean.png' },
  { name: 'white',  title: 'White', img: urlStatic+'PixelAdmin/1.3.0/assets/demo/themes/white.png' }
];
...
var demo_template = [
  '<div id="demo-settings" class="hidden">',
