...
$.validator.addMethod("timeBR", function (value, element) {
...
$.validator.addMethod("cep",function(e,t){return this.optional(t)||/^\d{2}.\d{3}-\d{3}?$/.test(e)},"Informe um CEP válido");
...
$.validator.addMethod("datetimeBR", function (value, element) {
    ...
    return this.optional(element) || true;
}, "Informe uma data e hora válidos");
